...
<html>
<head>
<title>Út Khờ Salon | Tìm kiếm lịch hẹn</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Tìm kiếm lịch hẹn</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Tìm kiếm lịch hẹn / Tên / Số điện thoại liên lạc:</h4>
	<div class="form-body">
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center">Kết quả "<?php echo $sdata;?>" từ khóa </h4> 

						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th> Tên lịch hẹn</th> <th>Tên</th><th>Số điện thoại</th> <th>Ngày hẹn</th><th>Thời gian hẹn</th><th>Hoạt động</th> </tr> </thead> <tbody>
<?php
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8"> Không tìm thấy hồ sơ nào về tìm kiếm này</td>
