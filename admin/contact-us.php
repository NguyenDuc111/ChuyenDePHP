...
<html>
<head>
<title>Út Khờ Salon | Liên hệ với chúng tôi</title>
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Cập nhật Liên hệ với chúng tôi</h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Cập nhật Liên hệ với chúng tôi:</h4>
						</div>
						<div class="form-body">
							<form method="post">
