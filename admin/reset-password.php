...
<html>
<head>
<title>Út Khờ Salon | Đặt lại trang </title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page login-page ">
				<h3 class="title1">Đặt lại mật khẩu Admin</h3>
				<div class="widget-shadow">
					<div class="login-top">
						<h4>Chào mừng bạn trở lại AdminPanel! </h4> <br>
    ...
    echo $msg;
							...
							<input type="password" name="confirmpassword" class="lock" placeholder="Xác nhận mật khẩu mới" required="true">
