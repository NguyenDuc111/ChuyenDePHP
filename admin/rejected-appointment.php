...
<html>
<head>
<title>Út Khờ Salon | Từ chối lịch hẹn</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Từ chối lịch hẹn</h3>
					
					
				
					<div class="table-responsive bs-example widget-shadow">
						<h4>Từ chối lịch hẹn:</h4>
						<table class="table table-bordered" > <thead style="background-color:#f2b33f;"> <tr> <th>#</th> <th> Số Lịch hẹn</th> <th>Tên</th><th>Số điện thoại</th> <th>Ngày Hẹn</th><th>Giờ Hẹn</th><th>Hoạt động</th> </tr> </thead> <tbody>
<?php
