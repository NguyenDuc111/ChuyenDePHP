...
<body class="cbp-spmenu-push">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="jumbotron">
					<div class="container">
						<h1 style="color:#5dc1bd; font-size: 36px; margin-top: 5%;">Thêm khách hàng</h1>
					</div>
				</div>
				<div class="forms">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Tên</label> <input type="text" class="form-control" id="name" name="name" placeholder="Tên Khách hàng" value="" required="true"> </div> <div class="form-group"> <label for="exampleInputPassword1">Email</label> <input type="email" id="email" name="email" class="form-control" placeholder="Email" value="" required="true"> </div>
							 <div class="form-group"> <label for="exampleInputEmail1">Điện thoại</label> <input type="text" class="form-control" id="mobilenum" name="mobilenum" placeholder="Số điện thoại" value="" required="true" maxlength="10" pattern="[0-9]+"> </div>
							 <div class="radio">
